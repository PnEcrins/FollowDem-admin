...
class Animal(db.Model):
    ...
    animal_devices = db.relationship('AnimalDevice', backref='animals', cascade="save-update, delete", lazy='dynamic', foreign_keys='AnimalDevice.id_animal')
    animal_attributes = db.relationship('AnimalAttribute', backref='animals',cascade="save-update, delete",  lazy='dynamic', foreign_keys='AnimalAttribute.id_animal')
...
class Device(db.Model):
    ...
    id_device_type = db.Column(db.Integer(), db.ForeignKey('followdem.lib_device_type.id_device_type'), nullable=True)
    comment = db.Column(db.Text())
...
class AnimalDevice(db.Model):
    ...
    id_animal = db.Column(db.Integer(), db.ForeignKey('followdem.t_animals.id_animal', ondelete='CASCADE'), nullable=True)
    id_device = db.Column(db.Integer(), db.ForeignKey('followdem.t_devices.id_device'), nullable=True)
...
class AnimalAttribute(db.Model):
    ...
    id_animal = db.Column(db.Integer(), db.ForeignKey('followdem.t_animals.id_animal', ondelete='CASCADE'), nullable=True)
    id_attribute = db.Column(db.Integer(), db.ForeignKey('followdem.lib_attributes.id_attribute'), nullable=True)
